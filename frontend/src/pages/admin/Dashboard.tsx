  ...
  return (
    <DashboardLayout title="Dashboard Overview">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-5 mb-8">
        {/* Total Patients */}
        <div className="bg-white rounded-3xl p-6 border border-slate-100 card-shadow card-shadow-hover animate-slide-up delay-75 group">
        ...
        {/* Approved Doctors */}
        <div className="bg-white rounded-3xl p-6 border border-slate-100 card-shadow card-shadow-hover animate-slide-up delay-150 group">
          <div className="flex items-start justify-between mb-4">
        ...
        {/* Pending Approvals */}
        <div className="bg-white rounded-3xl p-6 border border-slate-100 card-shadow card-shadow-hover animate-slide-up delay-225 group relative overflow-hidden">
          {unapproved.length > 0 && (
        ...
        {/* Total Users */}
        <div className="bg-white rounded-3xl p-6 border border-slate-100 card-shadow card-shadow-hover animate-slide-up delay-300 group">
          <div className="flex items-start justify-between mb-4">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-7">
        ...
        <div className="lg:col-span-2 flex flex-col h-full">
          <div className="bg-white rounded-3xl border border-slate-100 card-shadow flex flex-col h-full animate-slide-up delay-150">
        ...
        <div className="lg:col-span-3 flex flex-col h-full">
          <div className="bg-white rounded-3xl border border-slate-100 card-shadow flex flex-col h-full animate-slide-up delay-225">
            <div className="flex items-center justify-between px-6 py-5 border-b border-slate-50">
              <div>
            ...
            <div className="px-6 py-4 bg-slate-50/50 rounded-b-3xl border-t border-slate-50 mt-auto">
